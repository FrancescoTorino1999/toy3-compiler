...
public class NotOp  extends ExprOp  implements Visitable {
    private String name;
    private Visitable expr1;
    private TypeEnum type;


    public NotOp(Mode mode, TypeEnum tipo, String name, Visitable expr1, TypeEnum type) {
        super(mode, tipo);
        this.name = name;
        this.expr1 = expr1;
        this.type = type;
    ...
    public NotOp(String name, Visitable expr1, TypeEnum type) {
        this.name = name;
        this.expr1 = expr1;
        this.type = type;
    }

    public NotOp(String name, Visitable expr1) {
        this.name = name;
        this.expr1 = expr1;
    }
