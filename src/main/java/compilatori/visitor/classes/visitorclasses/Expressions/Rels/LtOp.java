...
public class LtOp extends ExprOp implements Visitable {
    private String name; //indica che espressione binaria è: plus,...
    private Visitable expr1, expr2;
    private TypeEnum type;


    public LtOp(Mode mode, TypeEnum tipo, String name, Visitable expr1, Visitable expr2, TypeEnum type) {
        super(mode, tipo);
        this.name = name;
        this.expr1 = expr1;
        this.expr2 = expr2;
    ...
    public LtOp(String name, Visitable expr1, Visitable expr2, TypeEnum type) {
        this.name = name;
        this.expr1 = expr1;
        this.expr2 = expr2;
        this.type = type;
    ...
    public LtOp(String name, Visitable expr1, Visitable expr2) {
        this.name = name;
        this.expr1 = expr1;
        this.expr2 = expr2;
        type = TypeEnum.BOOL;
