...
public class GeOp extends ExprOp implements Visitable {
    private String name; //indica che espressione binaria è: plus,...
    private Visitable expr1, expr2;
    private TypeEnum type;


    public GeOp(Mode mode, TypeEnum tipo, String name, Visitable expr1, Visitable expr2, TypeEnum type) {
        super(mode, tipo);
        this.name = name;
        this.expr1 = expr1;
        this.expr2 = expr2;
    ...
    public GeOp(String name, Visitable expr1, Visitable expr2, TypeEnum type) {
        this.name = name;
        this.expr1 = expr1;
        this.expr2 = expr2;
        this.type = type;
    ...
    public GeOp(String name, Visitable expr1, Visitable expr2) {
        this.name = name;
        this.expr1 = expr1;
        this.expr2 = expr2;
        type = TypeEnum.BOOL;
